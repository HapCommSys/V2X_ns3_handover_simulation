...
NS_LOG_COMPONENT_DEFINE ("BaselineRepeatInfocom_a");
...
//   Config::SetDefault ("ns3::ThreeGppAntennaArrayModel::IsotropicElements", BooleanValue (true));
  ...
  ueNodes.Get(0)->GetObject<ConstantVelocityMobilityModel>()->SetVelocity(Vector(45/3.6*1.3, 0, 0));
