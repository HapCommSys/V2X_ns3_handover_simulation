...
*/
  ...
  if(m_e2mode_nr) {
    ...
    NS_LOG_UNCOND ("\nm_e2ip " << m_e2ip << " m_e2port " << m_e2port << " local_port " << local_port << " gnb_id " << gnb_id << " plmnId " << plmnId);
...
//      }
  ...
  if(m_e2mode_lte) {
    ...
    NS_LOG_UNCOND ("\nm_e2ip " << m_e2ip << " m_e2port " << m_e2port << " local_port " << local_port << " enb_id " << enb_id << " plmnId " << plmnId);
    Ptr<E2Termination> e2term =
