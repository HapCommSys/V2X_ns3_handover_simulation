...
MmWaveEnbNetDevice::BuildRicIndicationMessageCuUp(std::string plmId)
{
  ...
  for (auto ue : ueMap)
  {
    ...
    // NS_LOG_UNCOND ("\n Ue: " << ue.first << " " << ue.second << " m_e2RlcStatsCalculator: " 
    //   << m_e2RlcStatsCalculator << " " << typeid(m_e2RlcStatsCalculator).name() 
    //   << " rlcLatency: " << rlcLatency << " pduStats: " << pduStats << " rlcBitrate: " << rlcBitrate);
